...
RSpec.describe Like, :type => :model do
  it "user like event" do
    ...
    event = Event.create(title: "Tournoi de basket à Paris", cover:"http://www.ffbb.png", background:"http://www.ffbb.png", description:"Basket-ball event", adresse:"Paris, Basket")
    event.sport = sport
    event.save!

    event_2 = Event.create(title: "Tournoi de basket à Lyon", cover:"http://www.ffbb.png", background:"http://www.ffbb.png", description:"Basket-ball event2", adresse:"Lyon, Basket")
    event_2.sport = sport
    event_2.save!
